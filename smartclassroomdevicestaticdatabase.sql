...
INSERT INTO `device` (`controllerid`, `deviceid`, `devicename`, `devicetype`, `roomid`) VALUES
	(200000001, 1, 'LED1', 20001, 1),
	(200000001, 2, 'LED1', 20001, 1),
	(200000001, 3, 'LED1', 20001, 1);
...
-- 正在导出表  smartclassroomdevicestaticdatabase.devicetype 的数据：~1 rows (大约)
...
INSERT INTO `flushtime` (`table`, `time`) VALUES
	('device', '2016-01-05 03:17:22'),
	('devicetype', '2016-01-05 03:22:48'),
